...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        if game_state.turn_number == 0:
            wall_locations = [[0, 13], [1, 13], [2, 13], [3, 13], [3, 12],
                              [24, 13], [25, 13], [26, 13], [27, 13],
                              [5, 10], [6, 9], [7, 10], [8, 10],
                              [12, 10], [12, 9], [13, 10], [14, 10], [14, 9],
                              [18, 10], [19, 10], [20, 10], [21, 9], [22, 10]]
            turret_locations = [[2, 11], [25, 11]]
            support_locations = [[14, 2]]
        ...
        self.build_defences(game_state, wall_locations, turret_locations, support_locations)
